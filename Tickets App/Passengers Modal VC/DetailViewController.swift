...
class DetailViewController: UIViewController {
    ...
    lazy var adultView = ChoosePassengersView(title: "Взрослые: ", infoIcon: false, count: adultCounter)
    lazy var bikeView = ChoosePassengersView(title: "Велосипеды: ", infoIcon: true, count: bikeCounter)
    lazy var childView = ChoosePassengersView(title: "Дети: ", infoIcon: false, count: childCounter)
    ...
    private func configureSubviews() {
        ...
        titleLabel.text = "Выберите пассажиров"
